...
cd /d "%~dp0..\"
call orbitus_service.bat zapret_status
call orbitus_service.bat game_filter
call orbitus_service.bat double_fake

set "BIN=%~dp0..\bin\"
set "LISTS=%~dp0..\lists\"
cd /d %BIN%

start "Orbitus Service: %~n0" /min /high "%BIN%winws.exe" --wf-tcp=80,443,2053,2083,2087,2096,8443,%GameFilterTCP% --wf-udp=443,19294-19344,50000-50100,%GameFilterUDP% ^
...
--filter-udp=19294-19344,50000-50100 --filter-l7=discord,stun --dpi-desync=fake %doubleFake% --dpi-desync-fake-discord="%BIN%active_discord_udp.bin" --dpi-desync-fake-stun="%BIN%active_discord_udp.bin" --dpi-desync-repeats=3 --new ^
