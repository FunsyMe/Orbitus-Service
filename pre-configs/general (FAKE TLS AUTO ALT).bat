...
--filter-udp=19294-19344,50000-50100 --filter-l7=discord,stun --dpi-desync=fake --dpi-desync-fake-discord="%BIN%active_discord_udp.bin" --dpi-desync-fake-stun="%BIN%active_discord_udp.bin" --dpi-desync-repeats=3 --new ^
